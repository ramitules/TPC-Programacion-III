...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main>
        <section class="row" aria-labelledby="aspnetTitle">
            ...
            <asp:GridView ID="gvRutinas" runat="server" DataKeyNames="IdRutina" AutoGenerateColumns="false" CssClass="table table-hover align-middle mb-0" GridLines="None" EmptyDataText="No hay rutinas generales.">
                <Columns>
