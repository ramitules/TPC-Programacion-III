...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="card-body">
            ...
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-2">
                    ...
                    <asp:TextBox ID="txtPeso" runat="server" CssClass="form-control" TextMode="Number" Text="0" />
                </div>
                <div class="col-md-2">
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="text-end">
            <asp:Button ID="btnGuardar" runat="server" CssClass="btn btn-success px-4 py-2" Text="Asignar Rutina" OnClick="btnGuardar_Click" />
        </div>
    </div>
