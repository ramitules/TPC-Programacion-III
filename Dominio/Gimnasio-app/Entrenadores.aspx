<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Entrenadores.aspx.cs" Inherits="Gimnasio_app.Profesores" %>
    ...
    <div class="container mt-5">
        <div class="row align-items-center mb-4">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <asp:Button ID="btnRegistrar" runat="server" CssClass="btn btn-primary shadow-sm" Text="Registrar Nuevo Entrenador" OnClick="btnRegistrar_Click" />
            </div>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body p-0">
            <div class="table-responsive">
                ...
                <asp:GridView ID="dgvEntrenadores" runat="server" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Acciones" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center">
                            <ItemTemplate>
                                <a href='FormularioAdmins.aspx?idRol=4&id=<%# Eval("IdUsuario") %>' class="btn btn-outline-primary btn-sm px-3 shadow-sm">
