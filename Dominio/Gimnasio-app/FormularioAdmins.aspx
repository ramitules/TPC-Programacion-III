    ...
    <div class="container mt-5 mb-5">
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                ...
                <div class="mb-3">
                    <a id="btnVolver" runat="server" class="btn btn-link text-decoration-none p-0 text-muted">
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-header bg-danger text-white p-3">
                        <h4 class="mb-0 fs-5">
                            ...
                            <asp:Literal ID="litTituloFormulario" runat="server" Text=""></asp:Literal>
                        </h4>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex flex-column flex-sm-row justify-content-end gap-2 mt-4 pt-3 border-top">
                            ...
                            <a id="btnCancelar" runat="server" class="btn btn-light order-2 text-muted">Cancelar</a>
