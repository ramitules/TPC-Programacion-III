...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row align-items-center mb-4">
        ...
        <div class="col-md-6 text-md-end mt-3 mt-md-0">
            <asp:Button ID="btnRegistrar" runat="server" CssClass="btn btn-primary shadow-sm" Text="Registrar Nuevo Admin" />
        </div>
    </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="FormularioAdmins.aspx?id=1024" class="btn btn-outline-primary btn-sm px-3 shadow-sm">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="FormularioAdmins.aspx?id=1025" class="btn btn-outline-primary btn-sm px-3 shadow-sm">
                                    <i class="bi bi-pencil-square me-1"></i>Ver Detalle
                                </a>
                            </td>
                        </tr>
            ...
            <asp:GridView ID="dgvAdmins" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acciones" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center">
                        <ItemTemplate>
                            <a href='FormularioAdmins.aspx?id=<%# Eval("Id") %>' class="btn btn-outline-primary btn-sm px-3 shadow-sm">
                                <i class="bi bi-pencil-square me-1"></i>Ver Detalle
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
