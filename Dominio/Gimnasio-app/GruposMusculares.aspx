<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GruposMusculares.aspx.cs" Inherits="Gimnasio_app.GruposMusculares" %>
    ...
    <div class="container mt-5">
        <div class="row align-items-center mb-4">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <asp:Button ID="btnRegistrar" runat="server" CssClass="btn btn-primary shadow-sm" Text="Registrar Nuevo Grupo Muscular" OnClick="btnRegistrar_Click" />
            </div>
        </div>
